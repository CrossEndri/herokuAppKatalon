...
WebUI.setText(findTestObject('Object Repository/Page_The Internet/input_Username'), ' ')
WebUI.setText(findTestObject('Object Repository/Page_The Internet/input_Password'), ' ')
